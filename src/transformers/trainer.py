...
class Trainer:
    ...
    def _maybe_log_save_evaluate(
        ...
        if self.control.should_evaluate:
            metrics = self._evaluate(
                trial, ignore_keys_for_eval, limit_eval_sample_size=True
            )
    ...
    def evaluation_loop(
        ...
        max_eval_samples = (
            self.args.max_eval_samples * self.args.eval_batch_size
            if limit_eval_sample_size
            else -1
        )
